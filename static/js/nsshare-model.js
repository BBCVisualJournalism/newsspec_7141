...
define(['bootstrap'], function (news) {
    var STORY_PAGE_URL = 'http://www.bbc.co.uk/news/magazine-26354918',
    ...
    */
    var NSShareModel = function (config) {  
        ...
        if (opts.desc) {this.setOGPDescription(opts.desc); } else {this.setOGPDescription('Shared via BBC News Magazine'); }
        ...
        if (opts.message) {this.setShareMessage(opts.message); } else {this.setShareMessage('Arms wide open: The story behind Rio\'s Christ the Redeemer statue, via @BBCNewsMagazine'); }
        //http://www.bbc.co.uk/news/magazine-26354918
    };
    ...
    */
    NSShareModel.prototype.fbShareTarget = function () {
        ...
        '&link=' + (STORY_PAGE_URL || "http://www.bbc.co.uk/news/magazine-26354918") + // URL storypage
